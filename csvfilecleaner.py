...
class CSV_FILECLEANER():
    def __init__(self,master):
        ...
        self.file_menu.entryconfig("Save csv file", state="disabled")
        ...
        self.edit_menu.entryconfig("Delete duplicates", state="disabled")
        self.edit_menu.entryconfig("Drop Non Values", state="disabled")
        self.edit_menu.entryconfig("Fix Non Values", state="disabled")
    ...
    def dropdp(self):
        if self.pandascheck == "":
            msg.showerror("NO INPORT","NO FILE IMPORTED")
        else:
